...
static bool llm_load_tensors(
    ...
    // create tensors for the weights
    {
        ...
        switch (model.arch) {
            ...
            case LLM_ARCH_BITNET:
                {
                    int bitnet_n_vocab = 100287;
                    model.tok_embd = ml.create_tensor(ctx_input, tn(LLM_TENSOR_TOKEN_EMBD, "weight"), {n_embd, bitnet_n_vocab});
